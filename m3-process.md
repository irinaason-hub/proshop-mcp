...
## _TODO Этап 3. Подключение к хосту и прогон сценария_
...
**Промпты:** _TODO — заполнить дословным текстом тестового промпта и промпта на запрещённый переход после прогона_

**Что пошло не так:** _TODO — заполнить по факту (где агент в Claude Code перепутал порядок вызовов, что пришлось переспрашивать, какие проблемы были на подключении)_

**Итог:** _TODO — сколько заходов заняло, что бы сделали иначе_